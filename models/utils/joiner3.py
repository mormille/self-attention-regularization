...
class Joiner(nn.Module):
    def __init__(self, backbone = False, num_classes = 10, bypass=False, pos_enc = "sin", batch_size=10, hidden_dim=256, image_h=32, image_w=32, grid_l=4, penalty_factor="1", alpha=1):
