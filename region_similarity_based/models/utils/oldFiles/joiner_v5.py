...
__all__ = ['create_mask', 'penalty_mask', 'pos_emb', 'ImageNetJoiner','GM_Mask']
...
class ImageNetJoiner(nn.Module):
    def __init__(self, num_encoder_layers = 6, nhead=8, num_classes = 10, mask=None, pos_enc = "sin", batch_size=100, in_chans=3, hidden_dim=512, image_h=256, image_w=256, grid_l=16, gm_patch = 16, use_patches=True, head_type='Linear'):
        super().__init__()
        ...
        self.gm_mask = GM_Mask(patch_size=gm_patch, width=self.f_map_w, height=self.f_map_h)
