...
files = ["0","100000","200000","300000","400000","500000","600000","700000","800000","900000","1000000"]
path = "data/GramImageNet/train/train_CustomImageNet_32x32GridLabel_"
#train_path  = "data/GramImageNet/train/train_CustomImageNet_Normalized_FULL1M.tar"
#train_path = "data/GramImageNet/train/train_CustomImageNet_32x32GridLabel_900000.tar"
valid_path = "data/GramImageNet/val_CustomImageNet_32x32GridLabel_1000.tar"
...
for i in range(epochs):
    for i in range(len(files)):
        #Loading the DataSets
        train_ds = torch.load(path+files[i]+".tar")
        train_ds.transforms = transform
        ...
        file_name = "GramImageNet_FULL_GAN_Rotation_epochs-"+str(i)+"-beta-"+beta_str+"_lr-"+lr_str+".pkl"
