...
learner = GANLearner(dloader,gen,crt,generator_loss,critic_loss,gen_first=True,metrics=[Accuracy,Reconstruction_Loss,Curating_of_attention_loss]).to_distributed(args.local_rank)
